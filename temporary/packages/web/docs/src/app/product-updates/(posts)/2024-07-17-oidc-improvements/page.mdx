...
Hive Console supports Single-Sign-On (SSO) via OpenID Connect (OIDC) for a long time now. We heard
...
Hive Console using your OIDC provider. We believe this change provides a more user-friendly
...
with Hive Console even better. If you have any questions or feedback, please don't hesitate to reach
out to us.
