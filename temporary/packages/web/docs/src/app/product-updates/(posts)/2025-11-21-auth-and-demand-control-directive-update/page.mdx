...
<Callout type="note" title="No Action Needed for Hive Cloud Users">
  All schemas we've seen in our system are already compliant with these stricter rules. If you're
  using authorization or demand control directives in your schemas, you shouldn't need to make any
  changes.
</Callout>
