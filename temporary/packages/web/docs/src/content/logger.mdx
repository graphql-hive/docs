...
Lightweight and customizable logging utility designed for use within the Hive Console ecosystem. It
...
child.debug(
  "Child loggers inherit the parent log level function, so this won't be logged either",
);
