...
import { StackBlitz } from "@hive/design-system/hive-components/stack-blitz"
...
<StackBlitz file="app/list.component.ts" stackBlitzId="apollo-angular-code-generator-example" />
