...
> of [GraphQL Tools](https://graphql-tools.com)[*v6 and under*]) got a bad ra  when it was famously
> ab ndoned by Apollo in favor of
> their [Federation](https://apollographql.com/docs/federation) architecture some years back.
> Howev r, Stitching came under the stewardship of [The Guild]() and friends in 2020, and they've
> since overhauled it with numerous automation and performance en ancements. Seemingly out of
