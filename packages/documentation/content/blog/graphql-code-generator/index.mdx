...
<YoutubeIframe
  src="https://youtube.com/embed/00TqfHWQRoM"
...
<Callout type="warning" className="hive-bleed">
  This blog post refers to an outdated version, please check
  https://the-guild.dev/graphql/codegen for the latest docs!
</Callout>
