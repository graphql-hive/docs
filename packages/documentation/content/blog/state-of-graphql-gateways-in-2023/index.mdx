...
<Callout emoji="🚀" type="info">
  ...
  Router**](/blog/welcome-hive-router) - a high-performance,
...
<Callout emoji="📊" type="info">
  Prefer numbers? See the live, reproducible benchmark (RPS, p95/p99, CPU,
  memory): [GraphQL Gateway Performance
  Benchmarks](https://the-guild.dev/graphql/hive/federation-gateway-performance).
</Callout>

<Callout emoji="❣️" type="info">
  We would like to thank our partners and customers who took part in that
  journey!
</Callout>
