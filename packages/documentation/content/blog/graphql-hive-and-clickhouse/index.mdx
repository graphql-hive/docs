...
authors: [kamil]
date: 2022-11-08
description: Learn how ClickHouse enabled GraphQL Hive to scale from millions to billions of requests monthly.
---
...
<Callout emoji="🤓" type="info">
  ...
  developing GraphQL Hive is that in order to squeeze the most performance of a
...
<Callout emoji="🙋">
  ...
  technical bits and pieces of GraphQL Hive in the upcoming weeks, so stay
  tuned!
</Callout>
