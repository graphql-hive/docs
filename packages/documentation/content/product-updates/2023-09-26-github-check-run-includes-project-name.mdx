...
**Before**
![Github check-run without project name](./2023-09-26-github-check-run-includes-project-name/before.png)

**After**
![Github check-run with project name](./2023-09-26-github-check-run-includes-project-name/after.png)
