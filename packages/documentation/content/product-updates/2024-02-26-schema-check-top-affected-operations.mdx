...
![Picture of top operations and clients for schema change](./2024-02-26-schema-check-top-affected-operations/schema-check-top-operations-clients.png)
...
[Learn more on enabling conditional breaking changes.](/docs/schema-registry/management/targets#conditional-breaking-changes)
