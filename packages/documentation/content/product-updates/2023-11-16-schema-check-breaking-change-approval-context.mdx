...
![Approved by annotation](./2023-11-16-schema-check-breaking-change-approval-context/approved-by.png)
...
<Callout>
  Benefiting from this feature requires **upgrading to the `@graphql-hive/cli`
  version `0.31.0`**.
</Callout>
