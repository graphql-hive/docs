...
[Relay persisted queries](https://relay.dev/docs/router/guides/persisted-queries/).
...
If you are using
[Relay's Persisted Queries specification](https://relay.dev/docs/router/guides/persisted-queries/#example-implemetation-of-relaylocalpersistingjs),
