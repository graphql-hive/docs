...
<Callout>
  ...
  options (e.g. `upstreamTimeout`) — see the
  [Upstream Reliability](/docs/gateway/other-features/upstream-reliability) page and the
  [Config Reference](/docs/api-reference/gateway-config) for the full list.
</Callout>
