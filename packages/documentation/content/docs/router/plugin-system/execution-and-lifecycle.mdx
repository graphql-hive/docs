...
[`on_plugin_init` hook](/docs/router/plugin-system/hooks#on_plugin_init). Here is a simple example
...
Hive Router [supports OpenTelemetry at its core](/docs/router/observability/tracing), and uses the
