...
<Callout type="warning">
  `insecure_skip_ca_verification: true` disables verification of subgraph server certificates. Only
  use this for local development or controlled testing — never in production.
</Callout>
