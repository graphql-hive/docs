...
- [`persisted_documents`](./persisted_documents): Extract and resolve persisted
  document IDs from file, Hive, or named storage backends.
- [`storages`](./storages): Define reusable storage backends (S3 and S3-compatible)
  for supergraph and persisted documents loading.
