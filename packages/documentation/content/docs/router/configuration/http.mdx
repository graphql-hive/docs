...
You may also use named path parameters such as `/{tenant}/graphql`, `/graphql/{wildcard}` if you
wish to capture nested paths within the same request, or `/graphql/{tail}*` to capture any
