...
<Callout type="warning">
  Higher verbosity has a real performance cost. Keep `info` (or lower) in production and only raise
  the level temporarily when debugging. See
  [log level and performance](/docs/router/observability/logging#log-level-and-performance).
</Callout>
