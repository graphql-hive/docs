...
The error rate (as a fraction between `0.0` and `1.0`) above which the circuit breaker opens. For
example, `0.5` means the circuit trips when 50% or more of requests in the evaluation window fail.
