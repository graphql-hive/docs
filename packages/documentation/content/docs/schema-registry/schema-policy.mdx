...
import cliPolicyErrorImage from "./policy-cli-error.png";
import cliPolicyWarningImage from "./policy-cli-warning.png";
import policyOverrideConfigImage from "./policy-override-config.png";
import policyOverrideSeverityImage from "./policy-override-severity.png";
import policyOverviewImage from "./policy-overview.png";
import policyRulesConfigImage from "./policy-rules-config.png";
import policySeverityImage from "./policy-severity.png";
...
<Callout type="info">
  Disallowing projects to override the organization-level policies will prevent
  the projects from editing the project-level policy. If a previous policy has
  been set for the project, it will be ignored during schema checks.
</Callout>
