...
<Callout type="info">
  ...
  [Learn more](/docs/schema-registry/self-hosting/cdn-artifacts).
</Callout>
...
<Callout>
  ...
  page](/docs/schema-registry/management/targets#revoking-a-cdn-access-token), and create a new token.
</Callout>
...
```bash copy=false filename="Example response"
