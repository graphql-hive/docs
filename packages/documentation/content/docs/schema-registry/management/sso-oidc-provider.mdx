...
<NextImage alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdNewApp} />
...
<NextImage className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdAppSecret} />
...
<NextImage className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdAppSecretValue} />
...
<NextImage alt="Azure AD" className="mt-8 max-w-sm rounded-lg drop-shadow-md" src={azureAdEmail1} />
<NextImage alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdEmail2} />
<NextImage alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdEmail3} />
<NextImage alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdEmail4} />
