...
([How to create a new role](/docs/schema-registry/management/organizations#members)).
...
<Image alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdNewApp} />
...
<Image className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdAppSecret} />
...
<Image className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdAppSecretValue} />
...
<Image alt="Azure AD" className="mt-8 max-w-sm rounded-lg drop-shadow-md" src={azureAdEmail1} />
<Image alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdEmail2} />
<Image alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdEmail3} />
<Image alt="Azure AD" className="mt-8 max-w-xl rounded-lg drop-shadow-md" src={azureAdEmail4} />
