...
import accessTokenCreateButtonImage from "./access-token-create-button.png";
import accessTokenCreateSuccessImage from "./access-token-create-success.png";
import accessTokenDeleteActionImage from "./access-token-delete-action.png";
...
<Callout type="warning">
  **Important**: Treat access tokens like passwords. Keep them secret and revoke
  ...
  unused tokens to maintain security.
</Callout>
