...
import schemaExplorerImage from './schema-explorer.png'
...
<Callout type="info">
  ...
  plan](/docs/schema-registry/management/organizations#subscription-and-billing), and depends on the data you
