...
<Screenshot>![Laboratory](./lab.png)</Screenshot>
...
[Registry Access Token](/docs/schema-registry/management/targets#registry-access-tokens). You only need to have the
...
<Screenshot>![Laboratory Form](./lab-form.png)</Screenshot>
...
<Callout>
  We recommend using the CDN for consuming the GraphQL schema in your project.
  [See GraphQL Code Generator
  Integration](/docs/other-integrations/graphql-code-generator).
</Callout>
