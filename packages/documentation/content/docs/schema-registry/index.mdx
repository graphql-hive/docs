...
<Cards>
  <Cards.Card arrow href="/docs/schema-registry/get-started/single-project" title="Single Schema" />
  <Cards.Card arrow href="/docs/schema-registry/get-started/schema-stitching" title="Schema-Stitching" />
  <Cards.Card arrow href="/docs/schema-registry/get-started/apollo-federation" title="GraphQL Federation" />
</Cards>
...
<Callout type="info">
  Don't confuse this with the [high-availability CDN](/docs/schema-registry/high-availability-cdn.mdx). This command
