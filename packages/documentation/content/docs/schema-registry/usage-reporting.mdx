...
import usageClientsImage from "./usage-clients.png";
import usageLatencyImage from "./usage-latency-over-time.png";
import usageOperationsOverTimeImage from "./usage-operations-over-time.png";
import usageOperationsImage from "./usage-operations.png";
import usageRpmImage from "./usage-rpm-over-time.png";
import usageStatsImage from "./usage-stats.png";
...
<Callout type="info">
  Hive does not collect, process or store any data from your GraphQL operations
  or responses. Hive Client only transmits the metadata of your GraphQL
  operations to Hive: what fields were used, if there were any errors, etc.
</Callout>
