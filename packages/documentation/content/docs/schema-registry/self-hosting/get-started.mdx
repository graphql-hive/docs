...
```sh
curl -O https://raw.githubusercontent.com/graphql-hive/console/hive@9.6.0/docker/docker-compose.community.yml
```
...
```sh
wget https://raw.githubusercontent.com/graphql-hive/console/hive@9.6.0/docker/docker-compose.community.yml
```
...
export DOCKER_TAG=":9.6.0" # Pin this to an exact version
