...
<Cards>
  <Cards.Card arrow href="/docs/api-reference/cli#binary" title="Install Hive CLI as a binary" />
  <Cards.Card arrow href="/docs/api-reference/cli#nodejs" title="Install Hive CLI from NPM" />
</Cards>
