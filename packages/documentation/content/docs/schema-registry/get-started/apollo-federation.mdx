...
<FileTree>
  <FileTree.Folder defaultOpen name="subgraphs">
...
<Cards>
  <Cards.Card arrow href="/docs/schema-registry" title="Learn about the Schema Registry" />
  <Cards.Card arrow href="/docs/gateway" title="Learn about Hive Gateway (JavaScript)" />
  <Cards.Card arrow href="/docs/router" title="Learn about Hive Router (Rust)" />
  <Cards.Card
    arrow
  ...
  />
  <Cards.Card arrow href="/docs/schema-registry/management/access-tokens" title="Learn about Access Tokens" />
  <Cards.Card arrow href="/docs/other-integrations/ci-cd" title="CI/CD Integration" />
</Cards>
