...
<Tabs items={['Binary', 'Docker', 'Custom']}>
  ...
  <Tabs.Tab>
    ...
    Next, update `src/main.rs` file with the following content to add Hive Console:
    ...
    In case of any issues, please refer to the [official guide](https://www.apollographql.com/docs/router/customizations/custom-binary/) or [open an issue](https://github.com/graphql-hive/platform/issues/new) in Hive Console repository.
