...
plugins:
  hive.usage: {}
    ...
    #
    #  Uses x-graphql-client-name by default
    # client_name_header: "x-graphql-client-name",
    #  Uses x-graphql-client-version by default
    # client_version_header: "x-graphql-client-version",
    #
