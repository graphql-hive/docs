...
<Cards>
  <Cards.Card
    ...
    title="Hosted"
  />
  <Cards.Card arrow href="/docs/schema-registry/self-hosting/get-started" title="Self-Hosted" />
</Cards>
...
<Cards>
  <Cards.Card arrow href="/docs/gateway" title="Get Started" />
</Cards>

## Hive Router

Hive Router is a high-performance, open-source GraphQL Federation router written in Rust. It acts as
the central entry point for all incoming GraphQL requests, efficiently planning and executing them
across your distributed subgraph services. It can be ran as a Docker image or binary with minimal
configuration.

<Cards>
  <Cards.Card arrow href="/docs/router" title="Get Started" />
</Cards>
...
<Cards>
  <Cards.Card arrow href="/docs/logger" title="Improve Your Logs" />
</Cards>
