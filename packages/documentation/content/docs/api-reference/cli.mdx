...
<Callout>
  ...
  Specification](/docs/api-reference/link-specifications#meta) instead of using `--metadata`.
...
<Callout emoji="🔑" type="info">
  ...
  tokens](/docs/schema-registry/management/access-tokens).
</Callout>
...
<Callout emoji="🔑" type="info">
  ...
  project, to perform a composition according to your project configuration.
</Callout>
...
<Callout type="info">
  Don't confuse this with the [high-availability CDN](/docs/schema-registry/high-availability-cdn). This command is
