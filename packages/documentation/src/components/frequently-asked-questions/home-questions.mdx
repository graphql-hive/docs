...
- Can Hive Console be self-hosted?
  ...
  [Read about Self-Hosting Hive in our documentation](/docs/schema-registry/self-hosting/get-started).

- What counts as a GraphQL operation?

  Every GraphQL request that is processed by your GraphQL API and reported to Hive Console. If your
