...
export function HiveNavigation({
  ...
  return (
    <div
      className="sticky top-0 z-20 border-b border-beige-400/(--border-opacity) bg-[rgb(var(--nextra-bg,255,255,255))] px-6 py-4 text-green-1000 transition-[border-color] duration-500 md:mb-[7px] md:mt-2 dark:border-neutral-700/(--border-opacity) dark:text-neutral-200"
      ref={containerRef}
