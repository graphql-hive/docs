...
export const CardsColorful = ({
  cards,
  className,
}: CardsColorfulProps): ReactElement => (
      ...
      {cards.map((card) => (
        ...
        >
          <div className="w-3/4 lg:w-1/2">
            <h2 className="pb-1.5 text-xs font-semibold uppercase opacity-60">
              {card.category}
            </h2>
            <h3 className="pb-2.5 text-2xl font-bold md:text-3xl">
              {card.title}
            </h3>
