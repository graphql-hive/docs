...
export function ArchDecoration(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      height="432"
...
export function LargeHiveIconDecoration(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" height="217" viewBox="0 0 305 217" width="305" {...props}>
      ...
      <defs>
        ...
        <clipPath id="clip0_711_1997">
          <path d="M0 0H305V305H0z" fill="#fff" />
        </clipPath>
      </defs>
    </svg>
  );
