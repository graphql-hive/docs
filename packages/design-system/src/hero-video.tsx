  ...
  return (
    <section className={clsx("bg-gray-100 dark:bg-neutral-800", className)}>
      ...
      >
        ...
        >
          {mounted && youtubeId && (
            // eslint-disable-next-line react/iframe-missing-sandbox -- YouTube requires allow-scripts + allow-same-origin which defeats sandbox
            <iframe
          ...
          {mounted && !youtubeId && (
            // eslint-disable-next-line jsx-a11y/media-has-caption -- captions not available for all videos
            <video
