  ...
  ({ children, className, href, ...rest }, ref) => {
    return (
      <Anchor
        ...
        className={cn(
          "hive-focus -mx-1 -my-0.5 rounded-sm px-1 py-0.5 font-medium text-blue-700 underline underline-offset-2 hover:no-underline focus-visible:no-underline focus-visible:ring-current focus-visible:ring-offset-blue-200 dark:text-primary/90 dark:focus-visible:ring-primary/50",
          className,
        )}
        href={href || ""}
        ref={ref}
